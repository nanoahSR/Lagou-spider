...
public class LagouSearcher {
    public static void main(String[] args) {
        ...
        webDriver.get("https://www.lagou.com/beijing-zhaopin/Java/?labelWords=label");
        webDriver.findElement(By.className("body-btn")).click();


        // 跳转页面
        clickOption(webDriver, "工作经验", "不限");
        clickOption(webDriver, "学历要求", "不限");
    ...
    private static void clickOption(WebDriver webDriver, String choseTitle, String optionTile) {
